"""
Django settings for artificial project.
...
SECRET_KEY = 'django-insecure-e7abodga1=w5x4f)s#u!)^dh(67#=-n2%@ob#6h7&j$vc%v&ia'
...
ALLOWED_HOSTS = [
    '127.0.0.1', 
    'localhost',
    '192.168.12.7',  # Adicione este host
]
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'width': '100%',
        'extraPlugins': ','.join([
            'uploadimage',  # Adicione se deseja suporte a upload de imagem
            'div',
            'autolink',
            'autoembed',
            'embedsemantic',
